const charFields = [
  ...
  { label: "Occupation", type: "textarea" },
  { label: "Abilities", type: "textarea" },
  { label: "Appearance", type: "textarea" },
  { label: "Goals", type: "textarea" },
];
const storyFields = [
  { label: "Title", type: "input" },
  { label: "Genre", type: "input" },
  { label: "Description", type: "textarea" },
];
const sceneFields = [
  { label: "Title", type: "input" },
  { label: "Location", type: "textarea" },
  { label: "Additional Participants", type: "textarea" },
